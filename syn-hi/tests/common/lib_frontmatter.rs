...
/// the correct frontmatter delimiters, then [FrontmatterExtractionResult::NoFrontmatter] is
/// returned. Otherwise [FrontmatterExtractionResult::ValidFrontmatter] is returned.
