...
2. We will then walk parts of this tree and generate code using `quote!` which will
   generate a new `TokenStream` that will then be returned by our procedural macro.
