...
5. And even other ASTs generated by `quote!()` using
   [`parse_quite!()`](https://docs.rs/syn/latest/syn/macro.parse_quote.html).
...
3. There's an extra input argument that attribute macros get passed which holds the
   arguments used to annotate the item. This is optional.
...
1. Variant 1 - passing an argument that looks like a key value pair to the macro.
